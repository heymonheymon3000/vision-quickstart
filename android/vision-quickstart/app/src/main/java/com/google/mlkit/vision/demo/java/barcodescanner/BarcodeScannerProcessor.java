...
import com.google.mlkit.vision.demo.java.DetectionArea;
...
public class BarcodeScannerProcessor extends VisionProcessorBase<List<Barcode>> {
  ...
  protected void onSuccess(
    ...
    for (int i = 0; i < barcodes.size(); ++i) {
      ...
      DetectionArea detectionArea = new DetectionArea(graphicOverlay, 200);
      if(detectionArea.getBoundingBox().contains(barcode.getBoundingBox())) {
